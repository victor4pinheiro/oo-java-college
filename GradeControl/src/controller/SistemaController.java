...
public class SistemaController {
  ...
  /**
   * Retorna uma lista do tipo <Curso> de cursos
   * 
  ...
  /**
   * Verifica se o texto passado via parâmetro contém caracteres do tipo numérico
   * 
   * @param text texto a ser verificado
   * @return true se o texto conter números, caso contrário, retorna falso
   */
